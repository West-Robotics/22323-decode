...
public class blue6Gate extends Base_Robot_Auto {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(20.71794871794872,124.24871794871795, Math.toRadians(320)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path1 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(20.718, 124.249),

                                    new Pose(48.205, 96.308)
                            )
            ...
            Path10 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    new Pose(48.333, 96.282),

                                    new Pose(48.128, 133.846)
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(90))
